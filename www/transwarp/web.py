...
'''
A simple, lightweight, WSGI-compatibale web framework.
'''
...
class Request(object):
    ...
    def remote_addr(self):
        ...
        '192.168.0.100'
        '''
        return self._environ.get('REMOTE_ADDR', '0.0.0.')
...
def _default_error_handler(e, start_response, is_debug):
    if isinstance(e, HttpError):
        ...
        headers = e.headers[:]
        headers.append(('Conten-Type', 'text/html'))
